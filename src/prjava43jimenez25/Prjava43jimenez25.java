package prjava43jimenez25; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.sql.*;
import java.io.*; 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43jimenez25 extends Frame 
   ...
   public Prjava43jimenez25 () { 
      ...
      setTitle("nova finestra prjava43jimenez25");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43jimenez25();  // Let the construct do the job 
   } 
